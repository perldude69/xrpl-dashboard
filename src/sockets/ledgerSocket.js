  ...
  io.on('connection', (socket) => {
    ...
    socket.on('getCurrentLedgerTransactions', async () => {
      try {
        ...
        const transactions = ledgerData.result.ledger.transactions || [];
        console.log('Fetched ledger transactions:', transactions.length);
        ...
        console.log('Sample raw tx:', transactions[0]);
        console.log('Sample processed tx:', processedTransactions[0]);
